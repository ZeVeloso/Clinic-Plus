...
import clinic.view.calendar.FXCalendarCell.WeekCell;
import clinic.view.calendar.FXCalendarCell.DateCell;
...
public class BasePane extends Group {
	...
	private void generateWeekCells(int count) {
		...
		List<FXCalendarCell.WeekCell> wkCells = new ArrayList<WeekCell>(count);
